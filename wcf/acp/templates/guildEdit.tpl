...
<form id="guildEditForm" method="post" action="{link controller='GuildEdit'}{/link}" enctype="multipart/form-data">
	<div class="section">
        ...
        <dl>
			...
			<dd>
				<p>{$guild->getLeader()->charname} <input type="text" name="charsearch" id="charsearch" value=""></p> 
		...
		<dl{if $errorField == 'birthtime'} class="formError"{/if}>
			...
			<dd>
				<input type="datetime" id="birthtime" name="birthtime" value="{$guild->birthday}" class="medium">
				{if $errorField == 'time'}
