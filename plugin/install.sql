...
CREATE TABLE wcf1_gman_character_equip (
  ...
  KEY (charID, equipTime),
  UNIQUE KEY charEquip (charID, equipTime)
) ENGINE=InnoDB ;
...
ALTER TABLE wcf1_gman_character_equip ADD FOREIGN KEY (charID) REFERENCES wcf1_gman_wow_character (charID) ON DELETE CASCADE;
