...
ALTER TABLE wcf1_gman_wow_character CHANGE charID charID VARCHAR(35) NOT NULL COLLATE utf8mb4_bin;
...
ALTER TABLE wcf1_gman_guild CHANGE leaderID leaderID VARCHAR(35) NOT NULL COLLATE utf8mb4_bin;
...
ALTER TABLE wcf1_gman_pointtrans CHANGE charID charID VARCHAR(35) NOT NULL COLLATE utf8mb4_bin
...
CREATE TABLE wcf1_gman_feedlist (
  ...
  charID VARCHAR(35) COLLATE utf8mb4_bin  NULL,
  itemID INT(10) NULL,
  acmID INT(10) NULL,
